...
namespace nest
{
class radial_basis_function_input : public Archiving_Node
{
...
inline port
radial_basis_function_input::send_test_event( Node& target,
  rport receptor_type,
  synindex,
  bool )
{
...
inline port
radial_basis_function_input::handles_test_event( SpikeEvent&, rport receptor_type )
{
  return 0;
}
