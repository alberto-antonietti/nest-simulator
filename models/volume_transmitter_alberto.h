...
#ifndef VOLUME_TRANSMITTER_ALBERTO_H_H
#define VOLUME_TRANSMITTER_ALBERTO_H_H
 ...
 * @ingroup Devices
 */
class volume_transmitter_alberto : public Archiving_Node
{
...
inline port
volume_transmitter_alberto::handles_test_event( SpikeEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
