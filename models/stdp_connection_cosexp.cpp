...
void STDPCosExpCommonProperties::get_status( DictionaryDatum& d ) const{
...
void STDPCosExpCommonProperties::set_status( const DictionaryDatum& d, ConnectorModel& cm ){
...
Node* STDPCosExpCommonProperties::get_node(){
  if ( vt_ == 0 )
